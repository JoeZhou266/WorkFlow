...
public class PerDiemsBatchOutStanding {
    public static void main( String[] args )
    {
    	ApplicationContext context = new ClassPathXmlApplicationContext("job/job-account-posting-jdbc.xml");
		JobLauncher jobLauncher = (JobLauncher) context.getBean("jobLauncher");
//		JobRepository jobRepository = (JobRepository) context.getBean("jobRepository");
		Job job = (Job) context.getBean("job_accountPosting");		
